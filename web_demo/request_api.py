...
# CUDA_VISIBLE_DEVICES=0  VLLM_USE_V1=0 vllm serve /home/scb123/PyProject/LLaMA-Factory/train_weight_jingyong --api-key zjuici --served-model-name qwen2.5-pt --port 23335 --uvicorn-log-level info --dtype float16  --max-model-len 8192

    url_chat = "http://localhost:8000/v1/chat/completions"
    url_complete = "http://localhost:8002/v1/completions"
    llm_model_id = "Qwen/Qwen2.5-72B-Instruct"
    
    clinet = LLMClient(url=url_complete, model_name=llm_model_id)
    res = clinet.post_llm_base("你是谁")
    print(res)